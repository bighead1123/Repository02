<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddRoomType.aspx.cs" Inherits="AddRoomType"  MasterPageFile="~/ContentMaster.master"%>
<asp:Content ID="AddRoomType" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
