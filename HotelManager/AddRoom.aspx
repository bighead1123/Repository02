<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddRoom.aspx.cs" Inherits="AddRoom" MasterPageFile="~/ContentMaster.master" %>
<asp:Content ID="AddRoom" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <table border="2px" cellpadding="1px" cellspacing="1px" style="border-color:#C1C1DB;">
            <tr>
                <td align="right">
                    房 间 号：</td>
                <td align="left" >
